...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText txtId, txDescripcion, txPeriodista, txFecha;
    private Button btnIngresar, btnlista, btnDelUp, btnescuchar;
    private ImageButton BtnTomarFotografia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txPeriodista = findViewById(R.id.txtperiodista);
        txFecha = findViewById(R.id.txtfecha);
        btnIngresar = findViewById(R.id.btningresar);
        BtnTomarFotografia = findViewById(R.id.imgBtnTomarFotografia4);
        imagenCapturada = findViewById(R.id.imagenCaputar4);
        db = FirebaseFirestore.getInstance();
        btnStartR = findViewById(R.id.btnStartRecording);
        btnStopR = findViewById(R.id.btnStopRecording);
        ...
        btnescuchar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivity.this, AudioAdapter.class);
        ...
        btnDelUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Crear un Intent para cambiar a ActividadListaEntrevistas
                Intent intent = new Intent(MainActivity.this, Activity_Actualizar_Eliminar.class);
                startActivity(intent); // Inicia la nueva actividad
            }
        });
        ...
        btnStartR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!hasRecordPermission()) {
                    ...
                    startRecording();
                    btnStartR.setVisibility(View.GONE);
                    btnStopR.setVisibility(View.VISIBLE);
                }
            }
        });

        btnStopR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                stopRecording();
                btnStopR.setVisibility(View.GONE);
                btnStartR.setVisibility(View.VISIBLE);
            }
        });
        ...
        btnIngresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String periodista = txPeriodista.getText().toString().trim();
                String fecha = txFecha.getText().toString().trim();
