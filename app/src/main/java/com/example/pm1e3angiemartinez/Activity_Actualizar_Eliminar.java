...
public class Activity_Actualizar_Eliminar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEliminar.setOnClickListener(v -> {
            ...
            // Eliminar
            // los documentos correspondientes de Firestore
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Actualizar_Eliminar.this, MainActivity.class);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (!listaEntrevistas.isEmpty()) {
                            ...
                            Toast.makeText(Activity_Actualizar_Eliminar.this, "No hay datos disponibles", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
        ...
        for (String id : idsFirestore) {
            db.collection("Entrevista")
                    ...
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Toast.makeText(Activity_Actualizar_Eliminar.this, "Eliminado de firebase ", Toast.LENGTH_SHORT).show();
                    })
                    .addOnFailureListener(e -> {
                        // Error al eliminar
                        // Puedes mostrar un mensaje de error o manejar la excepción aquí
                        Toast.makeText(Activity_Actualizar_Eliminar.this, "Error al eliminar: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
}
